...
# ghcr.io/butlerdotdev/capi-steward-bundle:$VERSION and ghcr.io/butlerdotdev/capi-steward-catalog:$VERSION.
IMAGE_TAG_BASE ?= ghcr.io/butlerdotdev/capi-steward
...
IMG ?= ghcr.io/butlerdotdev/capi-steward:$(VERSION)
